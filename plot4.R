...
# Transform the Date and Time vars from characters into objects of type Date and POSIXlt
...
# The basic plot function with different plot functions to build the 4 plots that form the graph
with(subpower,{
